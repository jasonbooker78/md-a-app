...
const coordinators = [
  { name: 'Maria R.', role: 'Lead CRC', status: 'acknowledged', timestamp: 'May 19, 2026 · 8:47 AM' },
...
export default function ComplianceDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* SAE Alert — highest priority, red */}
      <Banner
        variant="sae"
        title="New SAE · THN-204 · Logged 14 min ago by Maria R."
        body="Grade 3 adverse event — FDA 7-day expedited report due May 26, 2026."
        action="View Details"
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card accent="red" className="px-5 py-4">
          <p className="text-xs uppercase tracking-wide text-mda-gray-400 mb-1">Open SAEs</p>
          <p className="text-3xl font-bold text-mda-red">1</p>
          <p className="text-xs text-mda-gray-400 mt-1">Report due May 26, 2026</p>
        </Card>
      </div>
      ...
      <Card accent="red" className="overflow-hidden">
        ...
        <div className="px-5 py-4 flex items-center justify-between">
          <div className="space-y-1">
            <p className="text-sm font-semibold text-mda-gray-800">Grade 3 Adverse Event · R.C. (THN-204-012)</p>
            <p className="text-xs text-mda-gray-600">Protocol THN-204 · Logged by Maria R. · May 19, 2026 at 9:18 AM</p>
            <p className="text-xs text-mda-gray-400">Relatedness: Possibly related · Cycle 2 Day 1 visit</p>
          </div>
          <div className="text-right shrink-0 ml-6">
            <p className="text-xs uppercase tracking-wide text-mda-gray-400 mb-1">FDA Report Due</p>
            <p className="text-base font-bold text-mda-red">May 26, 2026</p>
